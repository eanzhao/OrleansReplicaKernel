...
try
{
    ...
    await host.DelayAsync(TimeSpan.FromMilliseconds(30));
    ...
    using var lateResponseTimeout = host.CreateTimeoutSource(TimeSpan.FromMilliseconds(50));
    ...
    await host.DelayAsync(stabilizationWindow + TimeSpan.FromMilliseconds(50));
    ...
    var interleavingStartedAt = host.GetTimestamp();
    ...
    var interleavingElapsed = host.GetElapsedTime(interleavingStartedAt);
